...
func NewConfig() *Config {
	...
	return &Config{
		...
		DeploymentName:                 getEnvWithDefault("DEPLOYMENT_NAME", "default"),
		ContainerName:                  getEnvWithDefault("CONTAINER_NAME", "default"),
		PodName:                        getEnvWithDefault("POD_NAME", "default"),
